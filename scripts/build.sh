...
BUILD_TIME=$(date "+%F %T")
goldflags="-s -w -X 'github.com/oldthreefeng/mycli/cmd.Version=$1' -X 'github.com/oldthreefeng/mycli/cmd.Githash=${COMMIT_SHA1}' -X 'github.com/oldthreefeng/mycli/cmd.Buildstamp=${BUILD_TIME}' -X github.com/oldthreefeng/mycli/cmd.Author=oldthreefeng"
